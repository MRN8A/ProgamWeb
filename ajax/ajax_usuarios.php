   ...
   <div id="caja4">
     <div id="texto1"><br>
        <fieldset style="width:auto;"    >
            <legend>Tipos de usuarios en la Tabla usuarios</legend>
          <br />
          <form id="formulario1">
                <div>
                    <p>
                      ...
                      <option value="0">-- Selecciona un tipo de usuario --</option>
                        <?php 
						     foreach ($rows as $row) 
						     {
                                echo '<option value="'.$row['tipousuario'].'">'.$row['tipousuario'].'</option>';
                             }
					    ?>
                      </select>
                    </p>
                    <p> 
                    <label for="ComboEmpleados">Usuarios del tipo seleccionado:</label>
                      <div id="txtHint"><b>En esta parte aparecerán los tipos de usuario seleccionados</b></div>
                    </p>
                    <p>
                    </p>
                </div>
